...
const projects: Project[] = [
  {
    ...
    description: [
      ...
      "Optimized for Google Search with structured data (JSON-LD), dynamic sitemap, meta tags, Open Graph, and Search Console integration.",
    ],
    tags: ["Next.js", "React", "TypeScript", "Tailwind", "AI Integration", "SEO"],
